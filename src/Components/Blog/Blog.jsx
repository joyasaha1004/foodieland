...
const Blog = () => {
  ...
  const previous = () => {
    ...
    return (
        <div className="overflow-x-hidden relative bg-black pt-7 pb-12 lg:pt-12 xl:pb-24">
            <div>
                <div className="mb-10 px-2 text-center ">
            <p className="text-amber font-serif lg:text-lg xl:text-2xl xxl:text-3xl">Our Blog</p>
                 <h3 className="text-lg font-semibold text-stone sm:text-xl lg:text-3xl xl:text-4xl xxl:text-5xl xl:mt-2 xxl:mt-4">Know More About The Article</h3>
                </div>

                <div className="w-52 justify-self-center sm:w-60 md:w-[465px] lg:w-[600px] xl:mt-12 xl:w-[1000px]  xxl:w-[1220px]">
        ...
        {...settings}>
            ...
            {BlogList.map((data)=>(
                ...
                <div className=" text-stone rounded h-[300px] sm:px-3 sm:h-[350px] lg:px-7 xl:px-8 xxl:h-[400px]">
                    <div>
                        <img src={data.img} className="h-[100px] w-[250px]  lg:h-[120px] xl:w-[270px] xl:h-[150px] xxl:w-[350px]"></img>
                    ...
                    <div className="bg-gray pt-20 py-3 px-2 sm:leading-5 lg:pt-24 xl:pt-24 xxl:pt-28">
                  ...
                  <div className="flex xxl:pt-2">
                   ...
                   <div className="flex mt-2 ml-12 cursor-pointer sm:ml-20 md:ml-20 lg:ml-28 xl:ml-24 xxl:ml-32 ">
