...
//         </div>
         <div className="overflow-x-hidden -mt-4  relative">
             ...
             <div className="bg-footer-pic bg-cover  relative h-fit pb-2 w-full">
                {/* <img src={footer} className="brightness-[0.5]" alt=""/> */}
              <div className="absolute inset-0 bg-black opacity-50 "></div>
                 <div className="relative">
                 <div className=" font-sans
                 flex absolute mt-1 ">
                ...
                <div>
                    ...
                    <ul className="nav-list flex flex-wrap px-2 pt-16 text-stone text-xs justify-self-center gap-4 sm:gap-6 sm:px-4 md:text-sm lg:text-base xl:gap-12 xxl:gap-16">
