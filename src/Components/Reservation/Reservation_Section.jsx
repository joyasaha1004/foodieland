        ...
        <div className="overflow-x-hidden  w-full bg-black pb-40">
            <div>
                ...
                <div className="absolute inset-0 bg-black opacity-50 "></div>
                 ...
                 <div className="">
                 <div className="mt-20 relative justify-items-center md:mt-24 lg:grid grid-cols-3  lg:mt-28 xl:mt-32 xxl:mt-36">
                    <img src={reservation1} className="w-40 h-56  relative md:w-52 md:h-64 lg:w-60 lg:h-80 xl:w-72 xl:h-[390px]  lg:mt-4 xxl:w-80 xxl:h-[450px]"></img>
                    ...
                    <div>
                     ...
                     <div className=" flex flex-wrap gap-2 place-content-center relative">
                         ...
                         <div className="w-full md:w-[80%] lg:w-[80%] xxl:w-[100%]">
...
<div className="relative justify-self-center mt-10 sm:mt-12">
            ...
            <div className="text-stone mt-7 px-2 relative place-content-center text-center  flex-wrap gap-2 sm:justify-between md:flex md:mt-10 md:px-4 lg:px-6 xl:px-10">
                <div className="">
                    <p className="text-xs lg:text-base md:mb-1 xl:text-lg xxl:text-xl">CALL US AND MAKE YOUR RESERVATION</p>
                    <span className="text-amber text-sm md:text-base lg:text-xl xl:text-2xl xxl:text-3xl">+9995574545</span>
                </div>
                
                <div className="">
                    <p className="text-xs lg:text-base md:mb-1 xl:text-lg xxl:text-xl ">OR SEND US AN EMAIL</p>
