...
const Contact_Section = () => {
    return (
        <div className="overflow-x-hidden w-full relative bg-black pb-20 max-w-screen-2xl mx-auto">

            <div className="bg-contact-bg relative w-full h-fit bg-cover bg-center pt-36 pb-40 lg:pt-48 lg:pb-52 xl:pt-64 xl:pb-64 ">
                
                 <div className="relative text-stone text-center ">
 
                     <h3 className=" text-2xl font-semibold font-serif text-amber md:text-3xl lg:text-4xl xl:text-5xl ">CONTACT</h3>
                     <p className="text-xs mt-2 tracking-[0.2em] md:text-sm lg:text-base xl:text-xl ">Contact Us To Enjoy Our Service</p>
                 </div>
            </div>
                 <div className="">
            <div className="relative mt-12 px-3 lg:px-7">
                    ...
                    <div className="text-stone text-xs  -mt-4  sm:px-5 md:text-sm md:px-10 lg:text-base lg:mt-2  xl:text-xl ">
                    ...
                    <div className="text-stone text-xs leading-[1.725] -mt-5 sm:px-5  md:text-sm md:px-10 md:-mt-3  lg:text-base xl:text-xl xl:mt-1 md:leading-[2.2] lg:leading-[2.1] xl:leading-[2]">
