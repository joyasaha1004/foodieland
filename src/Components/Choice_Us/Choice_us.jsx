...
<div className="bg-black pt-20  px-2 pb-24 lg:-mt-2 relative max-w-screen-2xl mx-auto overflow-x-hidden">
                 ...
                 <div className=" mt-1  relative self-center sm:justify-items-center md:mt-40 md:-ml-64 md:mt-44 lg:-ml-36 ">
                <img src={pot_food} className="w-44 h-40 ml-16 -mt-24 sm:-mt-32 sm:w-52 sm:h-48 relative xl:w-80 md:w-44 md:h-44 lg:w-64 lg:h-64 lg:-ml-2 "></img>
                 </div>
                 <div className="-pt-1 pl-5  sm:-pt-4 pb-5 md:pt-4 md:pl-10 lg:px-4 lg:pl-10 xl:pl-10 ">
                     <span className="-ml-2 text-orange lg:font-extrabold text-sm sm:text-base lg:text-xl font-serif xl:text-2xl">Why Us</span>
