...
<div className="bg-black pt-20 pb-2 px-2 lg:-mt-2 relative overflow-x-hidden">
                 <div className="bg-amber  px-2 lg:mx-5 w-full  relative overflow-hidden rounded md:flex xl:mx-7 ">
                 ...
                 <div className=" mt-1  relative sm:ml-20 md:mt-40 md:-ml-64 md:mt-44 lg:-ml-28 xxl:-ml-10">
                <img src={pot_food} className="w-44 h-40 ml-16 -mt-24 sm:-mt-32 sm:w-52 sm:h-48 relative xl:w-80 md:w-44 md:h-44 lg:w-64 lg:h-72 lg:-ml-2 xxl:w-[380px] xxl:h-80"></img>
                 ...
                 <div className="-pt-1 pl-5  sm:-pt-4 pb-5 md:pt-4 md:pl-10 xl:pl-16">
                     ...
                     <div className="-ml-10 mt-4 md:grid grid-cols-2 sm:mt-3 text-stone sm:mt-1 sm:gap-4 lg:mt-3 sm:-ml-8
                     ">
                         <div className="flex mb-4 sm:mb-4  md:w-[30vw] lg:w-60 xl:w-72 xxl:w-80"> 
                         ...
                         <div className=" sm:ml-1 leading-4 flex mt-5 md:w-[30vw]" >
                         ...
                         <div className="mb-4  leading-4 flex mt-5 md:w-[30vw]">
