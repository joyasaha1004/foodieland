...
<div className="w-full md:grid grid-cols-2 xl:grid-cols-3  h-fit relative md:-ml-5 xl:px-4">
   <div className="place-items-center ">
   <div className="border-b-4 border-s-4 -ml-32 rotate-90 rounded border-orange w-20 h-20 xl:-ml-40"></div>

   <div className="-mt-[76px]">    
       <img src={chef} className="w-48 h-56 md:h-72 xl:w-60 xl:h-80"></img>

       </div>
       <div className="border-t-4 border-e-4 ml-28 -mt-20 rotate-90 rounded border-orange w-20 h-20 relative xl:ml-40"></div>
   </div>

   <div className="px-3 pt-8 sm:pt-10 md:-mt-10 xl:-pl-10 xl:col-span-2">
   ...
   <div className=" relative">
        <img src={chilli} className="w-10 h-7 -mt-[55vh] ml-[80%] sm:ml-[10%] sm:-mt-[68vh] md:-mt-[62vh]"></img>
       <img src={noodle} className="w-16 h-10 mt-60 ml-44 sm:mt-80 sm:ml-80 md:ml-[150%] md:mt-72"></img>
   </div>
</div>
 </div>    
        </div>
