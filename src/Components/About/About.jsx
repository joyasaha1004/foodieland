...
const About = () => {
    return (
        <div className="bg-black pt-24 overflow-x-hidden lg:pb-7">
         <div className="  ">  
   ...
   <div className="px-3 pt-8 sm:px-6 sm:pt-10 md:-mt-10 lg:-mt-4 xl:-pl-10 lg:col-span-2 lg:px-20 xxl:-mt-0">
